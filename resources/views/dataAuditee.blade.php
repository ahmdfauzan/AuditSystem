                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            <div class="card-datatable text-nowrap">
                                    ...
                                    <div class="row card-header flex-column flex-md-row pb-0">
                                        <div
                                            ...
                                            <button class="me-3 mb-3 btn create-new btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#modalAuditee" tabindex="0"
                                ...
                                <form action="/tambahAuditee" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal fade" id="tambahAuditee" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel1"> Tambah Auditee
                                                    </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                ...
                                <form action="/importAuditee" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal fade" id="modalAuditee" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                ...
                                <h4 class="ms-4 mt-3">Master Data Auditee</h4>
                                        ...
                                        <tbody class="tableBody">
                                            @foreach ($dataAuditee as $data)
                                                <tr>
                                                    ...
                                                    @if(in_array(auth()->user()->level, ['Auditee', 'Master', 'Auditor']))
                                                    <td>
                                                        <form action="{{ route('deleteAuditee', $data->id) }}"
                                                        ...
                                                        <button class="btn btn-sm btn-primary"> <a href="#"
                                                                ...
                                                                data-bs-target="#editAuditee{{ $data->id }}">
                                                    ...
                                                    <td>
                                                        {{-- Upload Foto TTD --}}
                                                        <form action="{{ route('updateFotoAuditee', $data->id) }}"
                                                ...
                                                {{-- Modal Edit --}}
                                                <div class="modal fade" id="editAuditee{{ $data->id }}"
                                                    tabindex="-1" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <form action="{{ route('auditee.update', $data->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                <div class="modal-header">
